// import "https://tumbledry.sharda.co.in/favicon.png"
  ...
  event.waitUntil(
    caches.open("static-v1").then((cache) => {
      return cache.addAll([
        ...
        "https://tumbledry.sharda.co.in/favicon.png"
      ]);
    })
  );
});
...
self.addEventListener("push", (event) => {
  ...
  event.waitUntil(
    self.registration.showNotification(data.title, {
      body: data.body,
      icon: icon,
       badge: "https://tumbledry.sharda.co.in/favicon.png" // Optional: add a badge image
    })
  );
});
